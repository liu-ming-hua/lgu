...
def main(args):
    ...
    for idx, tid in enumerate(validation_generations):
        ...
        entropies['mean_token_entropy'].append(
            mean_token_entropy(most_likely_answer['token_log_likelihoods']))
        
        entropies['maximum_sequence_probability'].append(
            maximum_sequence_probability(most_likely_answer['token_log_likelihoods']))

        entropies['perplexity'].append(
            perplexity(most_likely_answer['token_log_likelihoods']))
        
        entropies['avg_neg_logp'].append(
            avg_neg_logp(most_likely_answer['token_log_likelihoods']))
        
        entropies['max_neg_logp'].append(
            max_neg_logp(most_likely_answer['token_log_likelihoods']))
